...
class Person(db.Model):
    ...
    def serialize(self):
        return{"ID":str(self.id),"NAME":self.name,"SURNAME":self.surname,"INSTRUMENT":self.instrument, "BIRTHDATE":self.birthdate,"PHONE":self.phone,"PHONE_PARENT":self.phone_parent,"EMAIL":self.email,"EMAIL_PARENT":self.email_parent}
