...
class Person(db.Model):
    ...
    def serialize(self):
        return{"ID":str(self.id),"Jméno":self.name,"Příjmení":self.surname,"Nástroj":self.instrument, "Narozen":self.birthdate,"Mobil":self.phone,"Mobil-rodiče":self.phone_parent,"Email":self.email,"Email-rodiče":self.email_parent}
